        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                _ProductCard(myImageUrl[0], myColors[0], 'The Product Title',
                    myTitles[0]),
                _ProductCard(myImageUrl[1], myColors[3], 'The Product Title',
                    myTitles[1]),
                _ProductCard(myImageUrl[2], myColors[2], 'The Product Title',
                    myTitles[2]),
                _ProductCard(myImageUrl[3], myColors[3], 'The Product Title',
                    myTitles[3]),
                _ProductCard(myImageUrl[0], myColors[0], 'The Product Title',
                    myTitles[0]),
                _ProductCard(myImageUrl[1], myColors[3], 'The Product Title',
