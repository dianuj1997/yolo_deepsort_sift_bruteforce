  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          getPermission();
          csvgenerator(_counter.toString(),_counter.toString());
...
Future<int> _readIndicator() async {
  ...
  try {
    ...
    String fullPath = "$path/For_Abdul_Wasay.csv";
...
void csvgenerator(String uuid, String distance) async{
  ...
  var f = await File(file + "/For_Abdul_Wasay.csv");
  ...
  if (dd==1)
  {
    ...
    print("There is file!");
    print("**********************************************************");
    final csvFile = new File(file + "/For_Abdul_Wasay.csv")
        .openRead();
